...
class PostSeeder extends Seeder
{
    ...
    {
        Post::create([
            'title' => 'Departemen Matematika UGM, Universitas Alma Ata, dan RMI PBNU Berkolaborasi Atasi Kesenjangan Numerasi Santri',
            'slug' => 'sarasehan-inclusive-mathematics-2025',
            'excerpt' => 'Sarasehan Guru Matematika Pesantren dengan tema "Inclusive Mathematics" diselenggarakan untuk memperkuat kapasitas guru dalam mengelola kelas dengan kemampuan matematika siswa yang beragam.',
            'content' => 'YOGYAKARTA, 15 November 2025 — Departemen Matematika Fakultas MIPA Universitas Gadjah Mada (UGM) hari ini (15/11) menyelenggarakan "Sarasehan Guru Matematika Pesantren" dengan tema "Inclusive Mathematics". Bekerja sama dengan Program Studi Pendidikan Matematika Universitas Alma Ata (UAA) Yogyakarta dan Rabithah Ma\'ahid Islamiyah (RMI) PBNU, kegiatan ini bertujuan memperkuat kapasitas guru dalam mengelola kelas dengan kemampuan matematika siswa yang beragam dan meningkatkan literasi numerasi di lingkungan pondok pesantren.

Sarasehan ini dilatarbelakangi oleh hasil Focus Group Discussion (FGD) tahun 2024 yang mengidentifikasi sejumlah tantangan utama di lingkungan pesantren. Tantangan tersebut mencakup kesenjangan kemampuan matematika siswa yang cenderung ekstrem, rendahnya penguasaan operasi hitung dasar, serta menurunnya minat siswa terhadap matematika.

Acara yang berlangsung di Ruang Sidang 1 Departemen Matematika FMIPA UGM ini diikuti oleh guru matematika dari 16 madrasah dan sekolah tingkat SLTA di lingkungan pondok pesantren wilayah Yogyakarta.

Turut hadir memberikan sambutan, Ketua Pengurus Wilayah Rabithah Ma\'ahid Islamiyah (PW RMI) D.I.Yogyakarta, KH. Muhammad Nilzam Yahya, M.Ag. Beliau menyoroti modal spiritual yang unik pada santri, yaitu riyadhoh dan tirakat, yang mana dengan modal itu, mereka bisa survive di lingkungan manapun, dengan cara terus belajar untuk sabar dan tangguh. Beliau berharap program penguatan kapasitas ini dapat dilaksanakan secara rutin dan berkelanjutan, tidak hanya sekali, demi memberikan dampak optimal bagi guru dan santri.
...
Menutup rangkaian sarasehan, Ketua Pelaksana, Dr. Danang Teguh Qoyyimi, Ph.D., memimpin sesi perencanaan tindak lanjut. Beliau menekankan bahwa sarasehan ini adalah langkah awal dari program jangka panjang \'Pemberdayaan Santri dalam STEM\'. Sesi tersebut merumuskan komitmen untuk tindak lanjut yang konkret dan berkelanjutan, guna memastikan program ini memberikan dampak yang nyata. Rencana kolaborasi ke depan, seperti workshop lanjutan dan pendampingan, akan didasarkan pada tantangan nyata yang telah dipetakan bersama para guru selama sarasehan.',
